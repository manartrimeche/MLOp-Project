...
> Système de prédiction de la concentration de dioxyde d'azote (NO2) dans l'air utilisant Machine Learning, MLflow et FastAPI.
...
- **RMSE** : 14.46 µg/m³
- **R²** : 0.9862
- **Tests** : 9/9 passent (94% couverture)

[Le reste de ton README existant...]
